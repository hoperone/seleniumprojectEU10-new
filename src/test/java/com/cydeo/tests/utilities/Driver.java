...
public class Driver {
    /*
    Creating a private constructor, so that we are closing access to the object of this class from outside the class.
     */
    private Driver() {
    }
    ...
    We also make it static because we will use it in a static method.
     */
